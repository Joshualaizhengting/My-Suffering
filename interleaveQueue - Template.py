...
# Write your code here #
    ...
    val = index / 2
    #first dequeue the first 3 elements and enqueue them to open the last half
    while not q.isEmpty() and val > 0:
        q.enqueue(q.dequeue())
        val -= 1
    
    val = index / 2
    #next we push the second half to a stack
    while not q.isEmpty() and val >0:
        stack.push(q.dequeue())
        val -= 1
    
    #enqueue the queue with itself and enqueue with what the stack pops one at a time
